...
/**
	...
	- 이슈사항2 : 내 아이디 갤러리나 사용자 아이디를 클리해서 출력하는 user타입의 갤러리 랜더링 시에는 사용자 아이디를 클릭할때마다 중복데이터 호출이 일어나기 때문에 해당 문제점을 해결하기 위해서 user타입의 갤러리가 렌더링 될때에만 state값을 변경하고 사용자 아이디의 클릭 이벤트를 막음으로서 불필요한 서버데이터 호출을 방지
 */
